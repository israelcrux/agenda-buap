...
CREATE TABLE IF NOT EXISTS `buap-comunication`.`events` (
  ...
  `status` TINYINT(1) NOT NULL COMMENT '0 No Aprobado\n1 Pendiente\n2 Aprobado\n3 En Proceso',
  `description` TEXT NULL,
...
CREATE TABLE IF NOT EXISTS `buap-comunication`.`requests` (
  ...
  INDEX `fk_requests_events1_idx` (`events_id` ASC),
...
CREATE TABLE IF NOT EXISTS `buap-comunication`.`events_has_targets_events` (
  `events_id` INT NOT NULL,
  `targets_events_id` INT NOT NULL,
  PRIMARY KEY (`events_id`, `targets_events_id`),
  INDEX `fk_events_has_targets_events_targets_events1_idx` (`targets_events_id` ASC),
  INDEX `fk_events_has_targets_events_events1_idx` (`events_id` ASC),
...
-- -----------------------------------------------------
-- Table `buap-comunication`.`events_has_services`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `buap-comunication`.`events_has_services` ;

CREATE TABLE IF NOT EXISTS `buap-comunication`.`events_has_services` (
  `events_id` INT NOT NULL,
  `services_id` INT NOT NULL,
  `start_service` DATE NOT NULL,
  `end_service` DATE NOT NULL,
  PRIMARY KEY (`events_id`, `services_id`),
  INDEX `fk_events_has_services_services1_idx` (`services_id` ASC),
  INDEX `fk_events_has_services_events1_idx` (`events_id` ASC),
...
INSERT INTO `buap-comunication`.`users` (`id`, `first_name`, `last_name`, `email`, `password`, `phone`, `extension_phone`, `status`, `remember_token`, `user_type_id`, `academic_administrative_unit_id`) VALUES (NULL, 'Jesús ', 'Cruz', 'jesus@buap.mx', '$2a$10$XjW2EHspJ6USdvHzB/mIDuEzPKYJ4vAYQOxCFPbot/3rXSc6GzGWq', NULL, NULL, 1, NULL, 1, 1);
...
START TRANSACTION;
USE `buap-comunication`;
INSERT INTO `buap-comunication`.`events` (`id`, `id_dci`, `name`, `start_day`, `end_day`, `place`, `time`, `head_name`, `head_email`, `head_phone`, `status`, `description`, `user_id`) VALUES (1, '141110', '1er Torneo Sabatino de Ajedrez Blitz para no clasificados', '2014-11-15 ', '2014-11-15', 'Complejo Cultural Universitario', '08:00:00', 'Fulanito Fulano Fulana', 'fulanito@buap.mx', '2221234567', 0, '', 1);
INSERT INTO `buap-comunication`.`events` (`id`, `id_dci`, `name`, `start_day`, `end_day`, `place`, `time`, `head_name`, `head_email`, `head_phone`, `status`, `description`, `user_id`) VALUES (2, '141108', 'Ballet Folklórico de México de Amalia Hernández', '2014-11-13 ', '2014-11-13', 'Complejo Cultural Universitario', '20:30:00', 'Sutanita Sutana Sutana', 'sutanita@gmail.com', '5598765432', 0, NULL, 2);
INSERT INTO `buap-comunication`.`events` (`id`, `id_dci`, `name`, `start_day`, `end_day`, `place`, `time`, `head_name`, `head_email`, `head_phone`, `status`, `description`, `user_id`) VALUES (3, '141110', 'Los Ángeles Azules Sinfónico Regresa Al Complejo', '2014-11-15 ', '2014-11-15 ', 'Complejo Cultural Universitario', '17:00:00', 'Perengano Perengano Perengano', 'perengano@outlook.com', '2221780442', 1, NULL, 3);
INSERT INTO `buap-comunication`.`events` (`id`, `id_dci`, `name`, `start_day`, `end_day`, `place`, `time`, `head_name`, `head_email`, `head_phone`, `status`, `description`, `user_id`) VALUES (4, '141108', 'México al Son de la Banda', '2014-11-13 ', '2014-11-13 ', 'Complejo Cultural Universitario', '11:00:00', 'Alguien Alguien Alguien', 'alguien@ar.buap.mx', '2222440487', 1, NULL, 1);
INSERT INTO `buap-comunication`.`events` (`id`, `id_dci`, `name`, `start_day`, `end_day`, `place`, `time`, `head_name`, `head_email`, `head_phone`, `status`, `description`, `user_id`) VALUES (5, '141108', 'México al Son de la Banda', '2014-11-13 ', '2014-11-13 ', 'Complejo Cultural Universitario', '17:00:00', 'Alguien Alguien Alguien', 'alguien@ar.buap.mx', '2222440487', 2, NULL, 2);
INSERT INTO `buap-comunication`.`events` (`id`, `id_dci`, `name`, `start_day`, `end_day`, `place`, `time`, `head_name`, `head_email`, `head_phone`, `status`, `description`, `user_id`) VALUES (6, '141110', 'México al Son de la Banda', '2014-11-15 ', '2014-11-15 ', 'Complejo Cultural Universitario', '12:00:00', 'Alguien Alguien Alguien', 'alguien@ar.buap.mx', '2222440487', 2, NULL, 3);
INSERT INTO `buap-comunication`.`events` (`id`, `id_dci`, `name`, `start_day`, `end_day`, `place`, `time`, `head_name`, `head_email`, `head_phone`, `status`, `description`, `user_id`) VALUES (7, '141110', 'Salsa El Taller', '2014-12-08', '2014-12-08', 'Complejo Cultural Universitario', '19:00:00', 'Otro Otro Otro', 'otro@ad.buap.mx', '1234567890', 3, NULL, 1);
INSERT INTO `buap-comunication`.`events` (`id`, `id_dci`, `name`, `start_day`, `end_day`, `place`, `time`, `head_name`, `head_email`, `head_phone`, `status`, `description`, `user_id`) VALUES (8, '141110', 'Salsa El Taller', '2014-12-09', '2014-12-09', 'Complejo Cultural Universitario', '19:00:00', 'Otro Otro Otro', 'otro@ad.buap.mx', '1234567890', 3, NULL, 2);
INSERT INTO `buap-comunication`.`events` (`id`, `id_dci`, `name`, `start_day`, `end_day`, `place`, `time`, `head_name`, `head_email`, `head_phone`, `status`, `description`, `user_id`) VALUES (9, '141110', 'Salsa El Taller', '2014-12-10', '2014-12-10', 'Complejo Cultural Universitario', '19:00:00', 'Otro Otro Otro', 'otro@ad.buap.mx', '1234567890', 0, NULL, 3);
...
START TRANSACTION;
USE `buap-comunication`;
INSERT INTO `buap-comunication`.`targets_events` (`id`, `name`, `description`) VALUES (1, 'Estudiantes', 'Dirigido a estudiantes.');
INSERT INTO `buap-comunication`.`targets_events` (`id`, `name`, `description`) VALUES (2, 'Administrativos', 'Dirigido a administrativos.');
INSERT INTO `buap-comunication`.`targets_events` (`id`, `name`, `description`) VALUES (3, 'Acádemicos/Investigadores', 'Dirigido a acádemicos e investigadores.');
INSERT INTO `buap-comunication`.`targets_events` (`id`, `name`, `description`) VALUES (4, 'Público en General', 'Dirigido al público en general.');
...
-- -----------------------------------------------------
-- Data for table `buap-comunication`.`events_has_targets_events`
-- -----------------------------------------------------
START TRANSACTION;
USE `buap-comunication`;
INSERT INTO `buap-comunication`.`events_has_targets_events` (`events_id`, `targets_events_id`) VALUES (1, 1);
INSERT INTO `buap-comunication`.`events_has_targets_events` (`events_id`, `targets_events_id`) VALUES (2, 2);
INSERT INTO `buap-comunication`.`events_has_targets_events` (`events_id`, `targets_events_id`) VALUES (3, 3);
INSERT INTO `buap-comunication`.`events_has_targets_events` (`events_id`, `targets_events_id`) VALUES (4, 4);
INSERT INTO `buap-comunication`.`events_has_targets_events` (`events_id`, `targets_events_id`) VALUES (5, 1);
INSERT INTO `buap-comunication`.`events_has_targets_events` (`events_id`, `targets_events_id`) VALUES (6, 2);
INSERT INTO `buap-comunication`.`events_has_targets_events` (`events_id`, `targets_events_id`) VALUES (7, 3);
INSERT INTO `buap-comunication`.`events_has_targets_events` (`events_id`, `targets_events_id`) VALUES (8, 4);
INSERT INTO `buap-comunication`.`events_has_targets_events` (`events_id`, `targets_events_id`) VALUES (9, 1);
