...
CREATE TABLE IF NOT EXISTS `buap-comunication`.`events` (
  ...
  `description` TEXT NULL,
  `status` ENUM('No Aprobado', 'Pendiente', 'En Proceso', 'Aprobado') NOT NULL DEFAULT 'Pendiente' COMMENT '0 No Aprobado\n1 Pendiente\n2 En Proceso\n3 Aprobado',
