...
START TRANSACTION;
USE `buap-comunication`;
INSERT INTO `buap-comunication`.`users` (`id`, `first_name`, `last_name`, `email`, `password`, `phone`, `extension_phone`, `remember_token`, `user_type_id`, `academic_administrative_unit_id`) VALUES (NULL, 'Javier ', 'Aguila', 'sjaca10@buap.mx', '$2a$10$hmOFJoVrG8XJCmLk34zIKe.pz4ndUNhfAlF.Jx5.P6R1L3jsyvRrG', NULL, NULL, NULL, 1, 1);
INSERT INTO `buap-comunication`.`users` (`id`, `first_name`, `last_name`, `email`, `password`, `phone`, `extension_phone`, `remember_token`, `user_type_id`, `academic_administrative_unit_id`) VALUES (NULL, 'Jesús ', 'Cruz', 'jesus@buap.mx', '$2a$10$XjW2EHspJ6USdvHzB/mIDuEzPKYJ4vAYQOxCFPbot/3rXSc6GzGWq', NULL, NULL, NULL, 1, 1);
INSERT INTO `buap-comunication`.`users` (`id`, `first_name`, `last_name`, `email`, `password`, `phone`, `extension_phone`, `remember_token`, `user_type_id`, `academic_administrative_unit_id`) VALUES (NULL, 'Ángelica ', 'Tenorio', 'angelica@buap.mx', '$2a$10$Y0GpbHflASQoa1oNmMle3OmnXU16ktkhiKxSV/PCbBKJb4NIb9l5K', NULL, NULL, NULL, 1, 3);
