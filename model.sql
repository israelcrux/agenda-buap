...
START TRANSACTION;
USE `buap-comunication`;
INSERT INTO `buap-comunication`.`academic_administrative_units` (`id`, `name`, `description`) VALUES (NULL, 'Facultad de Ciencias de la Computación', NULL);
INSERT INTO `buap-comunication`.`academic_administrative_units` (`id`, `name`, `description`) VALUES (NULL, 'Facultad de Administración', NULL);
INSERT INTO `buap-comunication`.`academic_administrative_units` (`id`, `name`, `description`) VALUES (NULL, 'Facultad de Arquitectura', NULL);
INSERT INTO `buap-comunication`.`academic_administrative_units` (`id`, `name`, `description`) VALUES (NULL, '', NULL);
...
START TRANSACTION;
USE `buap-comunication`;
INSERT INTO `buap-comunication`.`users` (`id`, `name`, `email`, `password`, `position`, `cell_phone`, `buap_extension_phone`, `secondary_email`, `description`, `remember_token`, `user_type_id`, `academic_administrative_unit_id`) VALUES (NULL, 'Javier Aguila', 'sjaca10@cs.buap.mx', '14576c492563dab99484a0649aa224d653268a50', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL);
