...
START TRANSACTION;
USE `buap-comunication`;
INSERT INTO `buap-comunication`.`users` (`id`, `name`, `email`, `password`, `phone`, `remember_token`, `user_type_id`, `academic_administrative_unit_id`) VALUES (NULL, 'Javier Aguila', 'sjaca10@buap.mx', '14576c492563dab99484a0649aa224d653268a50', NULL, NULL, 1, 1);
INSERT INTO `buap-comunication`.`users` (`id`, `name`, `email`, `password`, `phone`, `remember_token`, `user_type_id`, `academic_administrative_unit_id`) VALUES (NULL, 'Jesús Cruz', 'jesus@buap.mx', '71e7a33f24a70fd87e16c4fd61a1fa793f303323', NULL, NULL, 1, 1);
INSERT INTO `buap-comunication`.`users` (`id`, `name`, `email`, `password`, `phone`, `remember_token`, `user_type_id`, `academic_administrative_unit_id`) VALUES (NULL, 'Ángelica Tenorio', 'angelica@buap.mx', 'cd918218416d7d4a869d105829d3b8e59b088b17', NULL, NULL, 1, 3);
