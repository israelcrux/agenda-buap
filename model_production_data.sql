...
-- -----------------------------------------------------
-- Data for table `db554509897`.`pdi_programs`
-- -----------------------------------------------------
START TRANSACTION;
USE `db554509897`;
INSERT INTO `db554509897`.`pdi_programs` (`id`, `name`, `description`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Docencia', 'Programa I. Docencia.', '2015-02-11 16:46:40', '2015-02-11 16:46:40', NULL),
(2, 'Investigación y posgrado', 'Programa II. Investigación y posgrado.', '2015-02-11 16:46:40', '2015-02-11 16:46:40', NULL),
(3, 'Posicionamiento, visibilidad y calidad internacional', 'Programa III. Posicionamiento, visibilidad y calidad internacional.', '2015-02-11 16:46:40', '2015-02-11 16:46:40', NULL),
(4, 'Mantenimiento, adecuación y desarrollo de la infraestructura educativa', 'Programa IV. Mantenimiento, adecuación y desarrollo de la infraestructura educativa.', '2015-02-11 16:46:40', '2015-02-11 16:46:40', NULL),
(5, 'Gestión innovadora en los procesos administrativos', 'Programa V. Gestión innovadora en los procesos administrativos.', '2015-02-11 16:46:40', '2015-02-11 16:46:40', NULL),
(6, 'Ingreso, permanencia, egreso y titulación', 'Programa VI. Ingreso, permanencia, egreso y titulación.', '2015-02-11 16:46:40', '2015-02-11 16:46:40', NULL),
(7, 'Universidad y responsabilidad social', 'Programa VII. Universidad y responsabilidad social.', '2015-02-11 16:46:40', '2015-02-11 16:46:40', NULL),
(8, 'Compromiso, unidad y bienestar de los recursos humanos', 'Programa VIII. Compromiso, unidad y bienestar de los recursos humanos.', '2015-02-11 16:46:40', '2015-02-11 16:46:40', NULL),
(9, 'Integración social', 'Programa IX. Integración social', '2015-02-11 16:46:40', '2015-02-11 16:46:40', NULL),
(10, 'Impulsar el desarrollo de las unidades regionales', 'Programa X. Impulsar el desarrollo de las unidades regionales', '2015-02-11 16:46:40', '2015-02-11 16:46:40', NULL),
(11, 'Ninguno', NULL, '2015-02-11 16:46:40', '2015-02-11 16:46:40', NULL);
...
(27, 4, '2015-02-12 20:08:22', '2015-02-12 20:08:22', NULL),
(28, 4, '2015-02-12 21:25:31', '2015-02-12 21:26:48', NULL),
(29, 4, '2015-02-18 17:47:50', '2015-02-18 17:47:50', NULL),
(30, 2, '2015-02-18 19:20:10', '2015-02-18 19:20:10', NULL),
(35, 2, '2015-02-18 19:20:12', '2015-02-18 19:20:12', NULL);
...
START TRANSACTION;
USE `db554509897`;
INSERT INTO `db554509897`.`event_service` (`id`, `start_service`, `end_service`, `dci_status`, `created_at`, `in_process_at`, `attended_at`, `updated_at`, `deleted_at`, `event_id`, `service_id`) VALUES
...
START TRANSACTION;
USE `db554509897`;
INSERT INTO `db554509897`.`event_witness` (`file`, `dci_status`, `created_at`, `updated_at`, `deleted_at`, `event_id`, `witness_id`) VALUES
...
START TRANSACTION;
USE `db554509897`;
INSERT INTO `db554509897`.`support_materials` (`id`, `original_name`, `file`, `created_at`, `updated_at`, `deleted_at`, `event_id`) VALUES
...
START TRANSACTION;
USE `db554509897`;
INSERT INTO `db554509897`.`users_auth_operations` (`id`, `token`, `used`, `expiration`, `type`, `created_at`, `updated_at`, `deleted_at`, `user_id`) VALUES
...
-- -----------------------------------------------------
-- Data for table `db554509897`.`tasks`
-- -----------------------------------------------------
START TRANSACTION;
USE `db554509897`;
INSERT INTO `db554509897`.`tasks` (`id`, `status`, `description`, `comment`, `created_at`, `completed_at`, `updated_at`, `deleted_at`, `user_id`, `event_service_id`) VALUES
