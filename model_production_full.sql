...
-- -----------------------------------------------------
-- Table `db554509897`.`pdi_programs`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db554509897`.`pdi_programs` ;

CREATE TABLE IF NOT EXISTS `db554509897`.`pdi_programs` (
...
-- -----------------------------------------------------
-- Table `db554509897`.`event_pdi_program`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db554509897`.`event_pdi_program` ;

CREATE TABLE IF NOT EXISTS `db554509897`.`event_pdi_program` (
  ...
  CONSTRAINT `fk_pdi_programs_has_events_pdi_programs1`
    ...
    REFERENCES `db554509897`.`pdi_programs` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
